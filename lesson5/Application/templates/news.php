        ...
        <h2>Все новости</h2>
            ...
            foreach ($news as $article): ?>
                <article class="column-big-art">
                    ...
                    <a href="/controllers/news/article/?id=<?php echo $article['id'] // ArrayAccess?>">Перейти к новости</a>
                </article>
            <?php
        endforeach; ?>
    </div>
    ...
    <div class="column-middle">
        ...
        foreach ($last as $one): ?>
            <article class="column-small">
                <p><a href="/controllers/news/article/?id=<?php echo $article['id'] // ArrayAccess?>"><?php echo $one['title'];// ArrayAccess ?></a></p>
            </article>
            <?php
        endforeach; ?>
    </div>
